-- MySQL用户数据同步脚本
-- 将image_translator数据库的用户数据同步到yinghuo数据库
...
-- 插入image_translator数据库的用户数据（适配MySQL格式）
-- 注意：MySQL字段映射保持原有结构
INSERT INTO users (id, username, password, created_at, updated_at, last_login_at, phone, credits, is_admin, is_internal, is_customer_service, remark, is_banned, ban_reason, ban_expire_at) VALUES 
