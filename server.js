...
app.use((req, res, next) => {
  res.setHeader(
    ...
    "default-src 'self'; media-src 'self' blob: data: * https://*.aliyuncs.com https://*.alicdn.com https://*.aliyun.com https://*.dashscope.aliyuncs.com; script-src 'self' 'unsafe-inline' 'unsafe-eval' https://cdn.tailwindcss.com https://cdn.jsdelivr.net https://www.googletagmanager.com https://g.alicdn.com https://a.alicdn.com; connect-src 'self' https://api.openai.com https://exlzvpf9e2.execute-api.ap-southeast-1.amazonaws.com https://*.googleapis.com; img-src 'self' data: https: blob: https://*.aliyuncs.com https://*.alicdn.com https://*.aliyun.com; style-src 'self' 'unsafe-inline' https://cdn.jsdelivr.net; font-src 'self' https://cdn.jsdelivr.net; frame-src 'self' https://editor.d.design https://g.alicdn.com"
  );
  next();
});
