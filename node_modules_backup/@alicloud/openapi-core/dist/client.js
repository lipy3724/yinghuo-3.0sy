...
exports.ThrottlingError = exports.ServerError = exports.ClientError = exports.AlibabaCloudError = exports.SSEResponse = void 0;
        ...
        while ($dara.shouldRetry(_runtime['retryOptions'], _context)) {
            ...
            try {
                ...
                if ($dara.isNull(headers)) {
                    ...
                    request_.headers = Object.assign(Object.assign({ host: this._endpoint, 'x-acs-version': version, 'x-acs-action': action, 'user-agent': utils_1.default.getUserAgent(this._userAgent) }, globalHeaders), extendsHeaders);
                }
                else {
                    request_.headers = Object.assign(Object.assign(Object.assign({ host: this._endpoint, 'x-acs-version': version, 'x-acs-action': action, 'user-agent': utils_1.default.getUserAgent(this._userAgent) }, globalHeaders), extendsHeaders), headers);
                }
                ...
                try {
                    ...
                    try {
                        for (var events_1 = (e_1 = void 0, __asyncValues(events)), events_1_1; events_1_1 = yield __await(events_1.next()), !events_1_1.done;) {
                            ...
                            yield yield __await(new SSEResponse({
                                statusCode: response_.statusCode,
                                headers: response_.headers,
                                event: event,
                            }));
